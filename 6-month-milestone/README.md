This folder contains MITRE's hackathon and evaluation scenarios and supplementary materials, for the 6-month program milestone. It also contains performer solutions from the in-person evaluation event.
