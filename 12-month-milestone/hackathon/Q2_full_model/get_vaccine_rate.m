...
day0    = '1-jan-2020';
t_vac0  = 348; %daysact(day0,'14-dec-2020');  % AZ actually started on Mar 3 2021
t_delay = 516; %daysact(day0,'31-may-2021');  % at first, dosing delay is 16 weeks
t_vac_peak = 546; %daysact(day0,'30-jun-2021');  % vaccination rate peaks at the end of June
